const Day4Script = [
    ...
    { type: "dialogue", name: "旁白", text: "盧卡斯提著行李，正從清晨的薄霧中緩步朝我們走來。他今天沒有穿平時那身略顯嚴肅的制服，而是換上了一件挽起袖子的白襯衫，外面套了一件合身的黑色針織背心。襯衫領口隨意地解開了一顆釦子，挽起的袖口下，露出線條利落的小臂。" },
    ...
    { type: "dialogue", name: "旁白", text: "選對的瞬間，盧卡斯的私服殘影連同那些粉紅色泡泡一起「啵」地消散。我用力搖了搖頭，勉強把那些羞恥的妄想壓回腦袋最深處。" },
    { type: "sfx", src: "assets/audio/sfx/腳步聲.mp3" },
    { type: "dialogue", name: "旁白", text: "等我回過神，盧卡斯已經走到了我們面前。他臉上掛著極其溫和優雅的微笑，手裡還提著一個便利商店的紙袋，袋口飄出淡淡的咖啡香。" },
    ...
    { type: "dialogue", name: "旁白", text: "盧卡斯有些迷茫地眨了眨眼，但還是十分正經地點了點頭。" },
    ...
    { type: "dialogue", name: "旁白", text: "車窗外，連綿的針葉林與雲霧飛快地向後退去。而我——和盧卡斯並肩坐在這狹窄的雙人座上，連呼吸都不敢太大聲。" },
    { type: "dialogue", name: "旁白", text: "不知是因為昨晚的嚴重失眠，還是高海拔造成的空氣稀薄，亦或是體內那株「變異吐真孢子」又在作祟，我總覺得這小小的車廂裡，溫度高得有些異常。" },
    { type: "dialogue", name: "旁白", text: "尤其是身旁——盧卡斯身上那股清冽的雪松香氣，正伴隨著他的體溫，源源不斷地穿過這短短幾公分的距離，無孔不入地刺激著我的每一根神經。" },
    ...
    { type: "show_char", name: "盧卡斯", src: "assets/img/cha/盧卡斯_立繪_便服_擔心.png" },
    { type: "dialogue", name: "旁白", text: "盧卡斯轉過頭，略帶擔憂又無奈地，看著我此刻這副像是被點了穴的怪異姿勢。" },
    ...
    { type: "dialogue", name: "旁白", text: "盧卡斯看著我，眼底深處閃過一絲好笑又無奈的溫柔。他伸出手，幫我把頭頂上被睡意揉亂的紫髮稍微理了理，然後彎腰，一手提起了我們兩人的行李。" },
    ...
    { type: "show_char", name: "盧卡斯", src: "assets/img/cha/盧卡斯_立繪_便服_微笑.png" },
    { type: "dialogue", name: "旁白", text: "盧卡斯微笑著看向我，那溫和的目光讓我的心跳又漏了一拍。" },
    ...
    { type: "show_char", name: "盧卡斯", src: "assets/img/cha/盧卡斯_立繪_便服_微笑.png" },
    { type: "dialogue", name: "旁白", text: "盧卡斯看著我那張震驚得快要裂開的臉，有些好笑地、輕輕拍了拍我的肩膀。" },
    ...
    { type: "show_char", name: "盧卡斯", src: "assets/img/cha/盧卡斯_立繪_便服_笑.png" },
    { type: "dialogue", name: "旁白", text: "盧卡斯溫和地笑了笑，沒有拆穿我的慌張。他像是忽然想起什麼，轉頭看向社長。" },
    ...
    { type: "show_char", name: "盧卡斯", src: "assets/img/cha/盧卡斯_立繪_便服_擔心.png" },
    { type: "dialogue", name: "旁白", text: "盧卡斯一聽到「妻子」這個詞，嘴角微微抽動了一下，有些心有餘悸地摸了摸自己的耳朵。" },
    ...
    { type: "dialogue", name: "旁白", text: "盧卡斯，正背對著月光，靜靜地站在那裡。他似乎剛洗完澡，穿著一件深灰色的 V 領棉質居家服，額前微濕的紅棕色短髮，有些凌亂地散落著。" },
    ...
    // ------------------------------------------------------------------
    { type: "dialogue", name: "旁白", text: "我死死咬著下唇，用盡了意志力，才硬生生地把視線從盧卡斯微敞的領口上扯開，將腦袋裡那些狂湧的黃色廢料，連同口水一起吞回了肚子裡。" },
    ...
    { type: "dialogue", name: "旁白", text: "盧卡斯低低地笑了一聲，那低沉的震動聲，在寂靜的深夜裡顯得格外清晰。他轉過身，從旁邊的架子上取下一個乾淨的玻璃杯，替我倒了一杯溫水，然後端著它，朝我邁步走來。" },
    { type: "show_char", name: "盧卡斯", src: "assets/img/cha/盧卡斯_立繪_睡衣_普通.png" },
    ...
    { type: "dialogue", name: "旁白", text: "我用盡了全身最後一絲微弱的理智，猛地推開了盧卡斯的手，甚至連那杯溫水都顧不上接，像一隻受驚過度的兔子，轉身跌跌撞撞地逃回了樓梯上，一路衝回房裡，「砰」地一聲，死死鎖上了門。" },
